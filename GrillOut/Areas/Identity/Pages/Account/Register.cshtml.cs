...
namespace GrillOut.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { Name = Input.Name, PhoneNumber = Input.PhoneNumber, UserName = Input.Email, Email = Input.Email };
